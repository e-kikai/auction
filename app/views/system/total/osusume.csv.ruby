...
@rows.sum do |day|
  [day, @dl_counts[day],
    ...
    @follow_counts[day],
    @endo_counts[day], @tnew_counts[day], @mnew_counts[day], @zero_counts[day], @check_counts[day], @dlos_counts[day], @pops_counts[day],
    ...
    @follow_users[day],
    @dl_ips[day],
    @endo_ips[day], @tnew_ips[day], @mnew_ips[day], @zero_ips[day], @check_ips[day], @dlos_ips[day], @pops_ips[day],
