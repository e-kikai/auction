...
@rows.sum do |day|
  [day, @search_log_counts[day], @nms_counts[day], @search_user_counts[day], @nms_user_counts[day],
    @detail_log_counts[day], @to_nms_counts[day], @sca_counts[day], @nmr_counts[day],
    @detail_user_counts[day], @to_nms_user_counts[day], @sca_user_counts[day], @nmr_user_counts[day],
