class Myauction::TemplatesController < Myauction::ApplicationController
  ...
  def template_params
    params.require(:product).permit(:category_id, :code, :name, :note,
      ...
      :shipping_user,:shipping_comment, :international, :packing, :state, :state_comment, :returns, :returns_comment, :early_termination, :auto_extension, :auto_resale, :shipping_no, :addr_1, :addr_2,
      :template,
