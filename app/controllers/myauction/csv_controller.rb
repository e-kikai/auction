class Myauction::CsvController < Myauction::ApplicationController
  ...
  def csv_products_params
    params.require(:products).map { |p| p.permit(:code, :name, :description, :dulation_start, :dulation_end, :start_price, :prompt_dicision_price, :machinelife_id, :machinelife_images)}
  end
end
